...
def main(offset : int, size : int, name : str, data : bytearray):
    ...
    # Then we XOR 4 byte chuncks with this value and subtract 997 from the value for the next chunck
    ...
    for char in name:
        ...
        if offset > size:
            # I don't know if this inteded behaviour but seems to work fine
            continue
